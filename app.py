...
def handle_message(data):
    ...
    if reply_to:
        ...
        replied_msg = next((msg for msg in rooms[room_id]['chat_history'] if msg['id'] == reply_to), None)
        if replied_msg:
            msg_data['reply_username'] = replied_msg['username']
            msg_data['reply_message'] = replied_msg['message']
        else:
            msg_data['reply_username'] = '[Message not found]'
            msg_data['reply_message'] = ''
